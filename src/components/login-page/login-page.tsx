...
function LoginPage() {
  ...
  let [fullName, setFullName]: any | string = useState('');
  let [phoneNumber, setPhoneNumber]: any | string = useState('');
  let [email, setEmail]: any | string = useState('');
  let [password, setPassord]: any | string = useState('');
  let [confirmPassword, setConfirmPassord]: any | string = useState('');
  ...
  const submitForm = (event: any) => {
	...
	axios.post(baseUrl, formPayload, headers).then((response: any) => {
